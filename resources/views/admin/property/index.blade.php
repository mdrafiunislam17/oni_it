            ...
            <div class="container-xl px-4">
                <div class="page-header-content pt-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <h1 class="text-white"> All Project</h1>
...
{{--                                    <th> Size</th>--}}
                                ...
                                @forelse($property as $key => $item)
                                    <tr>
                                        ...
                                        <td>
                                            @if($item->image)
                                                <img src="{{ asset('uploads/property/' . $item->image) }}"
                                                     width="50" height="35"
...
{{--                                        <td>{{ $item->size }}</td>--}}
                                        <td>
                                            @if($item->propertyType == 'ongoing')
                                                <div>চলমান প্রপার্টি</div>

                                            @elseif($item->propertyType == 'outgoing')
                                                <div>বহির্গামী প্রপার্টি</div>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('dashboard.property.edit', $item->id) }}"
                                            ...
                                            <form id="delete-form-{{ $item->id }}"
                                                  action="{{ route('dashboard.property.destroy', $item->id) }}"
                                                  method="POST"
                                                  style="display:none;">
                                                @csrf
                                                @method('DELETE')
