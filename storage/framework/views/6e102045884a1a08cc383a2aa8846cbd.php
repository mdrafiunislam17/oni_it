<?php $__env->startSection("title", "Create About"); ?>
                ...
                <div class="col-lg-12">
                    <div id="default">
                        <div class="card mb-4">
                            ...
                            <form id="productForm"
                                  action="<?php echo e(route('dashboard.about.store')); ?>"
                                  method="POST"
...
<?php echo $__env->make("admin.layouts.master", array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\rafiun\Downloads\oneIt\resources\views/admin/abouts/create.blade.php ENDPATH**/ ?>