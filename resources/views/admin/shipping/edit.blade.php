                            ...
                            <div class="card-body">
                                ...
                                <div class="sbp-preview">
                                    <div class="sbp-preview-content">
                                        <form id="countryForm" action="{{ route('dashboard.shippingc.update', $shipping->id) }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            @method('PUT')
                                            ...
                                            <div class="row">
                                                    ...
                                                    <select class="form-control" id="page_id" name="page_id">
                                                        ...
                                                        @foreach($pages as $page)
                                                            <option value="{{ $page->id }}"
                                                                {{ old('page_id', $shipping->page_id ?? '') == $page->id ? 'selected' : '' }}>
                                                                {{ $page->title }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <input class="form-control" id="area" name="area" type="text" value="{{ old('area', $shipping->area) }}" >
                                                </div>

                                                <div class="col-md-4 mb-3">
                                                    <label for="charge" class="form-label">Charge <span class="text-danger">*</span></label>
                                                    <input class="form-control" id="charge" name="charge" type="text" value="{{ old('charge', $shipping->charge) }}" >
                                                </div>
                                            ...
                                            <div class="mb-0">
                                                ...
                                                <a href="{{ route('dashboard.shippingc.index') }}" class="btn btn-secondary">Back</a>
                                            </div>
                                            </div>
                                        </form>
                                    </div>
