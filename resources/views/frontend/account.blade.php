...
@section("title", "এ্যাকাউন্টস ডিরেক্টর")
    ...
    @push('styles')
        <style>
            ...
            .chair-hero__overlay {
                ...
                inset: 0;
                background:
                    linear-gradient(135deg, rgba(4, 54, 31, 0.94), rgba(17, 153, 142, 0.78)),
                    radial-gradient(circle at 20% 25%, rgba(255, 255, 255, 0.24), transparent 30%);
                z-index: -3;
            }

            .chair-hero__glow-one,
            .chair-hero__glow-two {
                position: absolute;
                border-radius: 999px;
                pointer-events: none;
                z-index: -2;
            ...
            .chair-hero__title {
                ...
                text-shadow: 0 14px 35px rgba(0, 0, 0, 0.16);
            }
                    ...
                    <aside class="chair-profile">
                        ...
                        <div class="chair-profile-info">
                            ...
                            <p class="designation">
                                ...
                                এ্যাকাউন্টস ডিরেক্টর ,এ্যারাবিয়ান গ্রুপ
                            </p>
                        </div>
                    ...
                    <main class="chair-content">
                        <div class="chair-content-head">
                            <div class="chair-kicker">
                                ...
                                সম্মানিত এ্যাকাউন্টস ডিরেক্টর ,এ্যারাবিয়ান গ্রুপের বার্তা
                            </div>
                        ...
                        <div class="chair-message-body">
                            @foreach(preg_split('/\r\n|\r|\n/', $account->description) as $message)
