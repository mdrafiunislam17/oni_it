                ...
                <div class="col-lg-12">
                    ...
                    <div class="card modern-card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <form id="productForm"
                                  action="{{ route('dashboard.about.update', $about->id) }}"
                                  method="POST"
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="description"
                                              id="description"
                                              class="form-control modern-input"
                                              placeholder="Write about description">{{ old('description', $about->description) }}</textarea>
                                </div>
                                ...
                                @if(!empty($about->image1))
                                    <div class="mb-4">
                                        <div class="image-card" id="currentImageBox2">
                                            ...
                                            <img src="{{ asset('uploads/about/' . $about->image1) }}"
                                                 class="preview-image"
