...
@section("title", "Create Special Goal")
                    ...
                    <div class="row align-items-center justify-content-between">
                        <div class="col-auto mt-4">
                            ...
                            <div class="page-header-subtitle mt-2">
                                Add a new Special Goal with image and description
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container-xl px-4 mt-n10">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <form id="productForm"
                          action="{{ route('dashboard.specialGoal.store') }}"
                          method="POST"
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text"
                                       ...
                                       name="title"
                                       value="{{ old('title') }}"
                                       placeholder="Enter Special Goal title"
                                       required>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text"
                                       ...
                                       name="serial"
                                       value="{{ old('serial') }}"
                                       placeholder="Enter Special Goal serial"
                                       required>
                            </div>
