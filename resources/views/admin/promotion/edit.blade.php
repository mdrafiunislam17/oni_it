        ...
        <div class="container-xl px-4 mt-n10">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <form id="productForm"
                          action="{{ route('dashboard.promotions.update',$promotions->id) }}"
                          method="POST"
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text"
                                       ...
                                       id="name"
                                       name="name"
                                       value="{{ old('name',$promotions->name) }}"
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="upload-box">
                                    ...
                                    <div class="image-preview-box"
                                        ...
                                        <img id="imagePreview"
                                             src="{{ asset('uploads/promotions/' . $promotions->image) }}"
                                             alt="Preview">
...
{{--                                          id="description"--}}
{{--                                          class="form-control"--}}
{{--                                          rows="10">{{ old('description',$promotions->description) }}</textarea>--}}
...
{{--                            </div>--}}
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control"
                                    ...
                                    <option value="main"
                                        {{ $promotions->type == 'main' ? 'selected' : '' }}>
                                        Main
                                    </option>

                                    <option value="wide"
                                        {{ $promotions->type == 'wide' ? 'selected' : '' }}>
                                        Wide
                                    </option>

                                    <option value="small"
                                        {{ $promotions->type == 'small' ? 'selected' : '' }}>
                                        Small
                                    </option>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control"
                                    ...
                                    <option value="1"
                                        {{ $promotions->status == 1 ? 'selected' : '' }}>
                                        Active
                                    </option>

                                    <option value="0"
                                        {{ $promotions->status == 0 ? 'selected' : '' }}>
                                        Inactive
                                    </option>
                        ...
                        <div class="action-btns">
                            ...
                            <a href="{{ route('dashboard.promotions.index') }}"
