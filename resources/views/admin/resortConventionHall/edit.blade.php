...
@section("title", "Edit Our ongoing projects")
    ...
    <main>
        ...
        <header class="page-header bg-gradient-primary-to-secondary pb-5">
            <div class="container-xl px-4 pt-4">
                <h1 class="text-white">Edit Our ongoing projects</h1>
            </div>
        </header>
        ...
        <div class="container-xl px-4 mt-n4">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form id="productForm"
                          action="{{ route('dashboard.resort-convention-halls.update', $resortConventionHall->id) }}"
                          method="POST"
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text"
                                       class="form-control"
                                       name="title"
                                       value="{{ old('title', $resortConventionHall->title) }}"
                                       placeholder="Enter resort convention hall title">
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text"
                                       class="form-control"
                                       name="location"
                                       value="{{ old('location', $resortConventionHall->location) }}"
                                       placeholder="Enter location">
                            </div>

                            {{-- Main Image --}}
                            <div class="col-md-12">
                                <label class="form-label">Our ongoing projects Image</label>
                                ...
                                <div class="upload-box">
                                    ...
                                    <div class="image-preview-box mt-3"
                                         id="imagePreviewBox"
                                         style="{{ $resortConventionHall->image ? 'display:block;' : '' }}">

                                        <img id="imagePreview"
                                             alt="Image Preview"
                                             src="{{ $resortConventionHall->image ? asset('uploads/resortConventionHall/'.$resortConventionHall->image) : '' }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            {{--
                            <div class="col-md-12">
                                <label class="form-label">Our ongoing projects Slider Images</label>
                                ...
                                <div class="upload-box">
                                    ...
                                    <div class="d-flex flex-wrap gap-2 mt-3">
                                        @if(!empty($resortConventionHall->floor_plans_image))
                                            @foreach(json_decode($resortConventionHall->floor_plans_image) as $img)
                                                <div class="floor-thumb">
                                                    <img src="{{ asset('uploads/resortConventionHall/'.$img) }}" alt="Slider Image">
                                                    <button type="button">×</button>
                                                    <input type="hidden" name="old_floor_plans_image[]" value="{{ $img }}">
                                                </div>
                                            @endforeach
                                        @endif
                                    </div>

                                    <div id="floorPreviewContainer" class="d-flex flex-wrap gap-2 mt-3"></div>
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea name="description"
                                          ...
                                          class="form-control"
                                          rows="6"
                                          placeholder="Write resort convention hall description">{{ old('description', $resortConventionHall->description) }}</textarea>
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <select name="status" class="form-control">
                                    <option value="1" {{ $resortConventionHall->status == 1 ? 'selected' : '' }}>
                                        Active
                                    </option>
                                    <option value="0" {{ $resortConventionHall->status == 0 ? 'selected' : '' }}>
                                        Inactive
                                    </option>
                                </select>
                            </div>
                        ...
                        <div class="action-btns">
                            ...
                            <a href="{{ route('dashboard.resort-convention-halls.index') }}"
...
@push("scripts")
    ...
    <script>
        ...
        // Multiple image preview - safe check
