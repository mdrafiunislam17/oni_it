...
@section("title", "Assign Role  List")
            ...
            <div class="container-xl px-4">
                <div class="page-header-content pt-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <h1 class="text-white">Assign Role List</h1>

{{--                        <a href="{{ route('dashboard.role.create') }}" class="btn btn-light text-primary">--}}
{{--                            + Add Assign Role--}}
{{--                        </a>--}}
                    </div>
                </div>
        ...
        <div class="container-xl px-4 mt-n10">
            ...
            <div class="card mb-4">
                <div class="card-header">All Assign Role</div>
                    ...
                    <div class="datatable-wrapper datatable-loading no-footer sortable searchable fixed-columns">
                        ...
                        <div class="datatable-container">
                            <table id="countryTable" class="datatable-table table align-middle">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="6" class="text-center">No Country Found</td>
                                    </tr>
                                @endforelse
                                </tbody>
                            </table>
    ...
    <div class="modal fade" id="assignroleModal" tabindex="-1" aria-labelledby="assignroleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="POST" action="{{ route('dashboard.assignrole.store') }}">
                    @csrf
                        ...
                        <div class="mb-3">
                            ...
                            @foreach ($roles as $role)
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input role-input" type="radio" name="role" id="role_{{ $role->id }}" value="{{ $role->name }}">
