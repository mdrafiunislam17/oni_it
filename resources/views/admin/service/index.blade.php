            ...
            <div class="container-xl px-4">
                <div class="page-header-content pt-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <h1 class="text-white"> All Arabian Park</h1>

{{--                        <a href="{{ route('dashboard.microcity.create') }}"--}}
...
{{--                        </a>--}}
        ...
        <div class="container-xl px-4 mt-n10">
            ...
            <div class="card mb-4">
                <div class="card-header">All Arabian Park</div>
...
{{--                                    <th> Size</th>--}}
                                ...
                                <tbody id="tableBody">
                                @forelse($microcity as $key => $item)
                                    <tr>
                                        <td>{{ $key + 1 }}</td>

                                        <td>
                                            @if($item->image)
                                                <img src="{{ asset('uploads/microcity/' . $item->image) }}"
                                                     width="50" height="35"
...
{{--                                        <td>{{ $item->size }}</td>--}}
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('dashboard.microcity.edit', $item->id) }}"
...
{{--                                                  action="{{ route('dashboard.microcity.destroy', $item->id) }}"--}}
{{--                                                  method="POST"--}}
{{--                                                  style="display:none;">--}}
{{--                                                @csrf--}}
{{--                                                @method('DELETE')--}}
{{--                                            </form>--}}
                                ...
                                @empty
                                    <tr>
                                        <td colspan="6" class="text-center">No Arabian Park  Found</td>
                                    </tr>
                                @endforelse
                                </tbody>
                            </table>
    ...
    <div id="deleteModal" class="custom-modal">
        <div class="custom-modal-content">
            <div class="icon">❗</div>
            <h3>Delete Arabian Park</h3>
            <p>Are you sure you want to delete this Arabian Park?<br>This action cannot be undone.</p>
