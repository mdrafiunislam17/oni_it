...
<head>
    ...
    <script data-search-pseudo-elements="" defer="" src="<?php echo e(asset('cdnjs.cloudflare.com/ajax/libs/font-awesome/6.3.0/js/all.min.js')); ?>" crossorigin="anonymous"></script>
    <script src="<?php echo e(asset('cdnjs.cloudflare.com/ajax/libs/feather-icons/4.29.0/feather.min.js')); ?>" crossorigin="anonymous"></script>
    <link rel="stylesheet" href="<?php echo e(url('https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css')); ?>">
...
<div id="layoutAuthentication">
                        ...
                        <div class="card my-5">
                            ...
                            <div class="card-body p-5">
                                ...
                                <form method="POST" action="<?php echo e(route('login')); ?>">
                                    ...
                                    <div class="mb-3"><a class="small" href="<?php echo e(route('password.request')); ?>">Forgot your password?</a></div>
    ...
    <div id="layoutAuthentication_footer">
        <footer class="footer-admin mt-auto footer-dark">
            <div class="container-xl px-4">
                <div class="row">
                    <div class="col-md-6 small">Copyright &copy; Your Website <?php echo e(now()->year); ?>

                        Developed by <a href="<?php echo e(url('https://oneit.bd/')); ?>" target="_blank">One It</a>
                    </div>
...
<script src="<?php echo e(asset('cdn.jsdelivr.net/npm/bootstrap%405.2.3/dist/js/bootstrap.bundle.min.js')); ?>" crossorigin="anonymous"></script>
<script src="<?php echo e(asset('js/scripts.js')); ?>"></script>

<script src="<?php echo e(asset('assets.startbootstrap.com/js/sb-customizer.js')); ?>"></script>
<sb-customizer project="sb-admin-pro"></sb-customizer>
<script defer src="<?php echo e(url('https://static.cloudflareinsights.com/beacon.min.js/v8c78df7c7c0f484497ecbca7046644da1771523124516')); ?>" integrity="sha512-8DS7rgIrAmghBFwoOTujcf6D9rXvH8xm8JQ1Ja01h9QX8EzXldiszufYa4IFfKdLUKTTrnSFXLDkUEOTrZQ8Qg==" data-cf-beacon='{"version":"2024.11.0","token":"6e2c2575ac8f44ed824cef7899ba8463","server_timing":{"name":{"cfCacheStatus":true,"cfEdge":true,"cfExtPri":true,"cfL4":true,"cfOrigin":true,"cfSpeedBrain":true},"location_startswith":null}}' crossorigin="anonymous"></script>
...
<?php /**PATH C:\Users\rafiun\Downloads\oneIt\resources\views/auth/login.blade.php ENDPATH**/ ?>