                ...
                <div class="col-lg-12">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <form id="sliderForm"
                                  action="<?php echo e(route('dashboard.slider.update', $slider->id)); ?>"
                                  method="POST"
                                ...
                                <input type="hidden"
                                       name="sort"
                                       id="sort"
                                       value="<?php echo e(old('sort', $slider->sort)); ?>">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="text"
                                            ...
                                            id="title"
                                            name="title"
                                            value="<?php echo e(old('title', $slider->title)); ?>"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="upload-box">
                                            ...
                                            <small class="text-muted d-block mt-2">
                                                New image দিলে crop size fixed 1920 × 994 px হবে।
                                                Old image crop করতে চাইলে preview image-এ click করুন।
                                            </small>

                                            <div class="image-preview-box"
                                                 id="imagePreviewBox"
                                                 style="<?php echo e($slider->image ? 'display:flex;' : ''); ?>">

                                                <img id="imagePreview"
                                                     src="<?php echo e($slider->image ? asset('uploads/slider/' . $slider->image) : ''); ?>"
                                                     data-old-src="<?php echo e($slider->image ? asset('uploads/slider/' . $slider->image) : ''); ?>"
                                                     alt="Image Preview">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-control"
                                            ...
                                            <option value="1" <?php echo e(old('status', $slider->status) == 1 ? 'selected' : ''); ?>>
                                                Active
                                            </option>

                                            <option value="0" <?php echo e(old('status', $slider->status) == 0 ? 'selected' : ''); ?>>
                                                Inactive
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="mt-4 d-flex gap-2 flex-wrap">
                                    ...
                                    <a href="<?php echo e(route('dashboard.slider.index')); ?>"
                ...
                <div class="crop-workspace">
                    ...
                    <div class="crop-side-panel">
                        ...
                        <div class="crop-help">
                            ...
                            <br>
                            1. New image select করলে crop modal open হবে।
                            <br>
                            2. Old image crop করতে preview image click করুন।
                            <br>
                            3. Mouse wheel দিয়ে zoom করুন।
                            <br>
...
<?php $__env->startPush("scripts"); ?>
    ...
    <script>
        ...
        function restoreOldPreview() {
            const oldSrc = imagePreview.getAttribute('data-old-src');

            if (oldSrc) {
                imagePreview.src = oldSrc;
        ...
        function initializeCropperWithImage(src) {
            if (!src) {
                return;
            }
        ...
        if (imageInput) {
            imageInput.addEventListener('change', function (event) {
                ...
                reader.onload = function (e) {
                    initializeCropperWithImage(e.target.result);
                };
        ...
        if (imagePreviewBox) {
            imagePreviewBox.addEventListener('click', function () {
                ...
                croppedImageInput.value = '';
                initializeCropperWithImage(currentImageSrc);
            });
        }
        ...
        sliderForm.addEventListener('submit', function (e) {
            if (imageInput.files.length > 0 && !croppedImageInput.value) {
                e.preventDefault();
                alert('Please crop the selected image first.');
                return;
            }
...
<?php echo $__env->make("admin.layouts.master", array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\rafiun\Downloads\oneIt\resources\views/admin/slider/edit.blade.php ENDPATH**/ ?>