...
@section("title", "চেয়ারম্যানের বার্তা")
                ...
                <div class="chair-card">
                    ...
                    <main class="chair-content">
                        ...
                        <div class="chair-message-body">
                            @foreach(preg_split('/\r\n|\r|\n/', $chairman->description) as $message)
                        ...
                        <div class="chair-signature-area">
                            ...
                            <div class="chair-signature-box">
                                <strong>{{ $chairman->title }}</strong>
                                <span>

                                    চেয়ারম্যান , এ্যারাবিয়ান গ্রুপ
                                </span>
                            </div>
                        </div>
                    </main>
