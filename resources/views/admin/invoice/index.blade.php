        ...
        <div class="cs-invoice_in" id="download_section">
            ...
            <div class="cs-invoice_head  cs-mb25">
                <div class="cs-invoice_left cs-mr97">
                    ...
                    <p class="cs-mb8">Jennifer Richards <br> 365 Bloor Street East, Toronto, <br> Ontario, M4W 3L4,
                        <br> Canada
                    </p>
                </div>
                <div class="cs-invoice_right cs-text_right">
                    ...
                    <div class="cs-table_responsive">
                        <table>
                            ...
                            <tr>
                                ...
                                <td class="cs-text_right cs-primary_color">$19.00</td>
                            </tr>
                            <tr>
                                <td>02</td>
                                <td>Fashion Photography</td>
                                <td>$26.00</td>
                                <td class="cs-text_center">3</td>
                                <td class="cs-text_right cs-primary_color">$78.00</td>
                            </tr>
                            <tr>
                                <td>03</td>
                                <td>Conceptual Photography</td>
                                <td>$29.00</td>
                                <td class="cs-text_center">1</td>
                                <td class="cs-text_right cs-primary_color">$29.00</td>
                            </tr>
                            <tr>
                                <td>04</td>
                                ...
                                <td>$50.00</td>
                                <td class="cs-text_center">1</td>
                                <td class="cs-text_right cs-primary_color">$50.00</td>
                            </tr>
                            <tr class="cs-focus_bg">
                                <td></td>
                                <td></td>
                                ...
                                <td class="cs-text_right cs-bold cs-primary_color">$176.00</td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <table>
                        ...
                        <tr class="cs-table_baseline">
                            ...
                            <td class="cs-width_2 cs-text_rightcs-f16">
                                <p class="cs-primary_color cs-bold cs-f16 cs-text_right">$176.00</p>
