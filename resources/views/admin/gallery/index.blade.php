...
@section("title", "Spectacular List")
...
@section("content")
    ...
    <main>
            ...
            <div class="container-xl px-4">
                <div class="page-header-content pt-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <h1 class="text-white">Spectacular List</h1>

                        <a href="{{ route('dashboard.gallery.create') }}" class="btn btn-light text-primary">
                            + Add Spectacular
                        </a>
                    </div>
                </div>
        ...
        <div class="container-xl px-4 mt-n10">
            ...
            <div class="card mb-4">
                <div class="card-header">All Spectacular</div>
                    ...
                    <div class="datatable-wrapper datatable-loading no-footer sortable searchable fixed-columns">
                        ...
                        <div class="datatable-container">
                            <table id="countryTable" class="datatable-table table align-middle">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form id="delete-form-{{ $gallery->id }}"
                                                  action="{{ route('dashboard.gallery.destroy', $gallery->id) }}"
                                                  method="POST"
                                                  style="display:none;">
                                                @csrf
                                                @method('DELETE')
                                ...
                                @empty
                                    <tr>
                                        <td colspan="6" class="text-center">No Gallery Found</td>
                                    </tr>
                                @endforelse
                                </tbody>
                            </table>
