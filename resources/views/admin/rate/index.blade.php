...
@section("content")
    ...
    <main>
            ...
            <div class="container-xl px-4">
                <div class="page-header-content pt-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <h1 class="text-white"> All Rate</h1>

                        <a href="{{ route('dashboard.rate.create') }}"
        ...
        <div class="container-xl px-4 mt-n10">
            ...
            <div class="card mb-4">
                <div class="card-header">All Rate</div>
                    ...
                    <div class="datatable-wrapper datatable-loading no-footer sortable searchable fixed-columns">
                        ...
                        <div class="datatable-container">
                            <table id="countryTable" class="datatable-table table align-middle">
                                ...
                                @forelse($rate as $key => $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('dashboard.rate.edit', $item->id) }}"
                                            ...
                                            <form id="delete-form-{{ $item->id }}"
                                                  action="{{ route('dashboard.rate.destroy', $item->id) }}"
                                                  method="POST"
                                                  style="display:none;">
                                                @csrf
                                                @method('DELETE')
                                ...
                                @empty
                                    <tr>
                                        <td colspan="6" class="text-center">No Rate  Found</td>
                                    </tr>
                                @endforelse
                                </tbody>
                            </table>
    ...
    <div id="deleteModal" class="custom-modal">
        <div class="custom-modal-content">
            <div class="icon">❗</div>
            <h3>Delete Rate</h3>
            <p>Are you sure you want to delete this Rate?<br>This action cannot be undone.</p>
