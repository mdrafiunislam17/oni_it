...
@section("title", "Spectacular Create")
        ...
        <div class="container-xl px-4 mt-n10">
            <div class="row">
                <div class="col-lg-12">
                    <div id="default">
                        <div class="card mb-4">
                            <div class="card-header">Add Spectacular </div>
                            <div class="card-body">
                                ...
                                <div class="sbp-preview">
                                    <div class="sbp-preview-content">
                                        <form id="countryForm" action="{{ route('dashboard.gallery.store') }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    <label for="title" class="form-label">Spectacular Title </label>
                                                    <input class="form-control" id="title" name="title" type="text" value="{{ old('title') }}" placeholder="Enter country title">
                                                </div>
