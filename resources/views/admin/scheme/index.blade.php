            ...
            <div class="container-xl px-4">
                <div class="page-header-content pt-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <h1 class="text-white"> All Saving Scheme</h1>

{{--                        <a href="{{ route('dashboard.scheme.create') }}"--}}
...
{{--                        </a>--}}
        ...
        <div class="container-xl px-4 mt-n10">
            ...
            <div class="card mb-4">
                <div class="card-header">All Saving Scheme</div>
...
{{--                                            <a href="{{ route('dashboard.scheme.edit', $item->id) }}"--}}
{{--                                               class="btn btn-sm btn-warning">--}}
{{--                                                <i class="fas fa-edit"></i>--}}
{{--                                            </a>--}}

                                            <a href="{{ route('dashboard.scheme.show', $item->id) }}"
...
{{--                                                  action="{{ route('dashboard.scheme.destroy', $item->id) }}"--}}
{{--                                                  method="POST"--}}
{{--                                                  style="display:none;">--}}
{{--                                                @csrf--}}
{{--                                                @method('DELETE')--}}
{{--                                            </form>--}}
    ...
    <div id="deleteModal" class="custom-modal">
        <div class="custom-modal-content">
            <div class="icon">❗</div>
            <h3>Delete Scheme</h3>
            <p>Are you sure you want to delete this Scheme?<br>This action cannot be undone.</p>
