...
@section("title", "Create Our ongoing projects")
                    ...
                    <div class="row align-items-center justify-content-between">
                        <div class="col-auto mt-4">
                            <h1 class="page-header-title">
                                ...
                                Create Our ongoing projects
                            </h1>

                            <div class="page-header-subtitle mt-2">
                                Add a new Our ongoing projects with image and description
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container-xl px-4 mt-n10">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <form id="productForm"
                          action="{{ route('dashboard.resort-convention-halls.store') }}"
                          method="POST"
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text"
                                       ...
                                       name="title"
                                       value="{{ old('title') }}"
                                       placeholder="Enter Our ongoing projects title"
                                       required>
                            </div>
...
{{--                        <div class="col-md-12">--}}
{{--                                <label for="floor_plans_image" class="form-label">--}}
{{--                                    Our ongoing projects Slider Images--}}
{{--                                </label>--}}
