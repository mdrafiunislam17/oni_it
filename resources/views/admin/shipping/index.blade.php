...
@section("content")
    ...
    <main>
            ...
            <div class="container-xl px-4">
                <div class="page-header-content pt-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <h1 class="text-white">Shipping List</h1>

                        <a href="{{ route('dashboard.shippingc.create') }}" class="btn btn-light text-primary">
                            + Add Shipping
                        </a>
                    </div>
                </div>
        ...
        <div class="container-xl px-4 mt-n10">
            ...
            <div class="card mb-4">
                <div class="card-header">All Shipping</div>
                            ...
                            <table id="countryTable" class="datatable-table table align-middle">
                                ...
                                @forelse($shippings as $key => $shipping)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('dashboard.shippingc.edit', $shipping->id) }}"
...
{{--                                                  action="{{ route('dashboard.shippingc.destroy', $shipping->id) }}"--}}
{{--                                                  method="POST"--}}
{{--                                                  style="display:none;">--}}
{{--                                                @csrf--}}
{{--                                                @method('DELETE')--}}
