                            ...
                            <div class="card-body">
                                ...
                                <div class="sbp-preview">
                                    <div class="sbp-preview-content">
                                        <form id="countryForm" action="{{ route('dashboard.page.update', $page->id) }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            @method('PUT')
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input class="form-control" id="title" name="title" type="text" value="{{ old('title', $page->title) }}" >
                                                </div>
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <textarea name="description"
                                                              id="description"
                                                              class="form-control modern-input">{{ old('description', $page->description) }}</textarea>
