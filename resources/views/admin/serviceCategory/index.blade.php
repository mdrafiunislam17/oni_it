            ...
            <div class="container-xl px-4">
                <div class="page-header-content pt-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <h1 class="text-white"> All Service Category</h1>

{{--                        <a href="{{ route('dashboard.serviceCategory.create') }}"--}}
...
{{--                        </a>--}}
        ...
        <div class="container-xl px-4 mt-n10">
            ...
            <div class="card mb-4">
                <div class="card-header">All Service Category</div>
                    ...
                    <div class="datatable-wrapper datatable-loading no-footer sortable searchable fixed-columns">
                        ...
                        <div class="datatable-container">
                            <table id="countryTable" class="datatable-table table align-middle">
                                ...
                                <tbody id="tableBody">
                                @forelse($serviceCategory as $key => $item)
                                    <tr>
                                        <td>{{ $key + 1 }}</td>

                                        <td>
                                            @if($item->image)
                                                <img src="{{ asset('uploads/serviceCategory/' . $item->image) }}"
                                                     width="50" height="35"
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('dashboard.serviceCategory.edit', $item->id) }}"
...
{{--                                                  action="{{ route('dashboard.serviceCategory.destroy', $item->id) }}"--}}
{{--                                                  method="POST"--}}
{{--                                                  style="display:none;">--}}
{{--                                                @csrf--}}
{{--                                                @method('DELETE')--}}
{{--                                            </form>--}}
                                ...
                                @empty
                                    <tr>
                                        <td colspan="6" class="text-center">No Service Category  Found</td>
                                    </tr>
                                @endforelse
                                </tbody>
                            </table>
    ...
    <div id="deleteModal" class="custom-modal">
        <div class="custom-modal-content">
            <div class="icon">❗</div>
            <h3>Delete Service Category</h3>
            <p>Are you sure you want to delete this Service Category?<br>This action cannot be undone.</p>
