            ...
            <div class="container-xl px-4">
                <div class="page-header-content pt-4">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('dashboard.hero.create') }}" class="btn btn-light text-primary">
                            + Add Detail
                        </a>
                    </div>
                </div>
                            ...
                            <table id="countryTable" class="datatable-table table align-middle">
                                ...
                                @forelse($details as $key => $detail)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('dashboard.hero.edit', $detail->id) }}"
                                            ...
                                            <form id="delete-form-{{ $detail->id }}"
                                                  action="{{ route('dashboard.hero.destroy', $detail->id) }}"
                                                  method="POST"
                                                  style="display:none;">
                                                @csrf
                                                @method('DELETE')
