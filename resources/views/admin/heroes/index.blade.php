...
@section("content")
    ...
    <main>
            ...
            <div class="container-xl px-4">
                <div class="page-header-content pt-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <h1 class="text-white"> All HeroSection</h1>

                        <a href="{{ route('dashboard.hero.create', ['category_id' => request('category_id')]) }}"
        ...
        <div class="container-xl px-4 mt-n10">
            ...
            <div class="card mb-4">
                <div class="card-header">All HeroSection</div>
...
{{--                                    <th>Button Name</th>--}}
                                ...
                                <tbody id="tableBody">
                                @forelse($heroes as $key => $heroe)
                                    <tr>
                                        <td>{{ $key + 1 }}</td>

{{--                                        <td>--}}
{{--                                            @if($heroe->image)--}}
{{--                                                <img src="{{ asset('uploads/hero/' . $heroe->image) }}"--}}
{{--                                                     width="50" height="35"--}}
...
{{--                                        </td>--}}
                                        ...
                                        <td>{!! $heroe->name !!}</td>
                                        <td>{{$heroe->page->title ?? ''}}</td>
{{--                                        <td>{{ $heroe->button_text }}</td>--}}
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('dashboard.hero.edit', $heroe->id) }}"
...
{{--                                            <form id="delete-form-{{ $heroe->id }}"--}}
{{--                                                  action="{{ route('dashboard.hero.destroy', $heroe->id) }}"--}}
{{--                                                  method="POST"--}}
{{--                                                  style="display:none;">--}}
{{--                                                @csrf--}}
{{--                                                @method('DELETE')--}}
{{--                                            </form>--}}
                                ...
                                @empty
                                    <tr>
                                        <td colspan="6" class="text-center">No Visa Service  Found</td>
                                    </tr>
                                @endforelse
                                </tbody>
                            </table>
