...
<?php $__env->startSection("content"); ?>
                ...
                <div class="swiper-wrapper">
                    ...
                    <?php $__currentLoopData = $sliders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="swiper-slide">
                            <div class="swiper-inner" data-bgimage="url(<?php echo e(asset('uploads/slider/' . $slider->image)); ?>)">
                    ...
                    <div class="col-lg-6">
                        <div class="relative">
                            <div class="w-100 pe-5 pb-5 wow scaleIn">
                                <img src="<?php echo e(asset('uploads/about/' . $about->image)); ?>" class="w-100 rounded-1" alt="">
                            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="ps-lg-3">
                            ...
                            <p class="wow fadeInUp" data-wow-delay=".6s">
                                <?php echo e(Str::words(strip_tags($about->description), 50, '...')); ?>

                            </p>
                            <a href="<?php echo e(route('frontend.about')); ?>" class="btn-main fx-slide wow fadeInUp" data-wow-delay=".8s"><span> আরও জানুন </span></a>
    ...
    <section class="bg-dark-3">
        <div class="container relative z-2">
            <div class="row g-4">
                ...
                <!-- 1 -->
                <?php $__currentLoopData = $serviceCategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-lg-4 col-sm-6">
                    <div class="hover rounded-1 overflow-hidden relative text-light text-center wow fadeInRight" data-wow-delay=".0s">
                        <img src="<?php echo e(asset('uploads/serviceCategory/' . $item->image)); ?>" class="hover-scale-1-1 w-100" alt="">
                        ...
                        <img src="<?php echo e(asset('frontend/images/logo-big-white.webp')); ?>" class="abs abs-centered w-30" alt="">

                        <div class="abs bg-dark-1 z-2 top-0 w-100 h-100 hover-op-1"></div>

                        <div class="abs z-2 bottom-0 mb-3 w-100 text-center hover-op-0">
                            <h2 class="hs-3 mb-3"><?php echo e($item->title); ?></h2>
                        </div>
                    ...
                    <div class="row g-5 align-items-center">
                        <div class="col-lg-5">
                            <div class="leader-image-wrap">
                                <img src="<?php echo e(asset('uploads/about/' . $chairman->image)); ?>" alt="<?php echo e($chairman->title); ?>">
                                <div class="leader-badge">
                                    <h5><?php echo e($chairman->title); ?></h5>
                        ...
                        <div class="col-lg-7">
                            <div class="leader-content ps-lg-3">
                                ...
                                <div class="leader-quote wow fadeInUp" data-wow-delay=".3s">
                                    ...
                                    <p>
                                        <?php echo e(Str::words(strip_tags($chairman->description), 100, '...')); ?>
                                ...
                                <a href="<?php echo e(route('frontend.chairman')); ?>" class="btn-main fx-slide wow fadeInUp" data-wow-delay=".5s">
                                    <span>আরও জানুন</span>
                                </a>
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="leader-message-card wow fadeInUp">
                    <div class="row g-5 align-items-center flex-lg-row-reverse">
                        <div class="col-lg-5">
                            <div class="leader-image-wrap">
                                <img src="<?php echo e(asset('uploads/about/' . $md->image)); ?>" alt="<?php echo e($md->title); ?>">
                                <div class="leader-badge">
                                    <h5><?php echo e($md->title); ?></h5>
                        ...
                        <div class="col-lg-7">
                            <div class="leader-content pe-lg-3">
                                ...
                                <div class="leader-quote wow fadeInUp" data-wow-delay=".3s">
                                    <i class="fa-solid fa-quote-left"></i>
                                    <p>
                                        <?php echo e(Str::words(strip_tags($md->description), 100, '...')); ?>
                                ...
                                <a href="<?php echo e(route('frontend.managingDirector')); ?>" class="btn-main fx-slide wow fadeInUp" data-wow-delay=".5s">
                                    <span>আরও জানুন</span>
                                </a>
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="leader-message-card wow fadeInUp">
                    <div class="row g-5 align-items-center">
                        <div class="col-lg-5">
                            <div class="leader-image-wrap">
                                <img src="<?php echo e(asset('uploads/about/' . $account->image)); ?>" alt="<?php echo e($account->title); ?>">
                                <div class="leader-badge">
                                    <h5><?php echo e($account->title); ?></h5>
                        ...
                        <div class="col-lg-7">
                            <div class="leader-content ps-lg-3">
                                ...
                                <div class="leader-quote wow fadeInUp" data-wow-delay=".3s">
                                    <i class="fa-solid fa-quote-left"></i>
                                    <p>
                                        <?php echo e(Str::words(strip_tags($account->description), 100, '...')); ?>
                                ...
                                <a href="<?php echo e(route('frontend.account')); ?>" class="btn-main fx-slide wow fadeInUp" data-wow-delay=".5s">
                                    <span>আরও জানুন</span>
                                </a>
                            </div>
                        </div>
    ...
    <section>
        <div class="container">
            ...
            <div class="row g-4">
                ...
                <?php $__currentLoopData = $properties->take(9); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $property): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-md-4 col-sm-6">
                        <div class="hover rounded-1 overflow-hidden relative mb-4">
                            <a href="<?php echo e(route('frontend.resort-convention-halls-detail',$property->title)); ?>">
                                <img src="<?php echo e(asset('uploads/resortConventionHall/' . $property->image)); ?>" class="w-100 hover-scale-1-2" alt="">
                            </a>
                        </div>

                        <h3> <a href="<?php echo e(route('frontend.resort-convention-halls-detail',$property->title)); ?>">
                                <?php echo e(Str::words($property->title,8,'...')); ?>

                            </a>  </h3>

                        <p class="mb-0">
                            <a href="<?php echo e(route('frontend.resort-convention-halls-detail',$property->title)); ?>">
                                <?php echo Str::words($property->description,25,'...'); ?>
    ...
    <section class="bg-color-op-1">
        <div class="container relative z-2">
            ...
            <div class="row g-4">
                <?php $__currentLoopData = $goals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $goal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-lg-4 col-md-6">
                        <div class="relative">
                            <div class="abs fs-40 w-80px p-4 bg-dark-3 rounded-1 text-white text-center wow rotateIn"
                                 data-wow-delay="<?php echo e(($key + 1) * 0.2); ?>s">
                                <?php echo e($key + 1); ?>

                            </div>

                            <div class="ps-80 ms-4 wow fadeInRight"
                                 data-wow-delay="<?php echo e($key * 0.2); ?>s">
                                <h3 class="hs-4"><?php echo e($goal->title); ?></h3>
                                <p><?php echo e($goal->description); ?></p>
                            </div>
                        </div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <section class="bg-color-op-9 vision-section">
        <div class="container relative z-2">
            ...
            <div class="row g-4">
                <?php $__empty_1 = true; $__currentLoopData = $visions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vision): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="col-lg-6 col-md-6 wow fadeInUp"
                         data-wow-delay="<?php echo e(($loop->iteration * .1)); ?>s">
...
<?php echo $__env->make("frontend.layouts.master", array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\Rafiun\arabiangroup\resources\views/frontend/index.blade.php ENDPATH**/ ?>