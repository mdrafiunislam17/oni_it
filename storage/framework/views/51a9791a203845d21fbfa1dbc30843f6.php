<?php $__env->startSection("title", "Slider Create"); ?>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <form id="sliderForm"
                                  action="<?php echo e(route('dashboard.slider.store')); ?>"
                                  method="POST"
                                  enctype="multipart/form-data">

                                <?php echo csrf_field(); ?>

                                <input type="hidden" name="sort" id="sort" value="<?php echo e($nextSort); ?>">
...
<?php echo $__env->make("admin.layouts.master", array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\rafiun\Downloads\oneIt\resources\views/admin/slider/create.blade.php ENDPATH**/ ?>