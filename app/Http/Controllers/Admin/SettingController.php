...
class SettingController extends Controller
{
    ...
    public function socialMedia(): View
    {
        ...
        return view("admin.settings.socialMedia", $this->compactSetting());
    }



    public function Secontact(): View
    {

        return view("admin.settings.contact", $this->compactSetting());
    }

    public function homepage(): View
    {

        return view("admin.settings.homepage", $this->compactSetting() );
    }
...
//                "HOME_PAGE_META_IMAGE",
    ...
    public function adminIndex(): View
    {
        ...
        return view('admin.settings.adminIndex',$this->compactSetting(),);
    }
    ...
    public function adminupdate(Request $request)
    {
        ...
        // পুরাতন password check
        if (!Hash::check($request->current_password, $user->password)) {
            return back()->withErrors(['current_password' => 'Current password does not match']);
        }

        // নতুন password update
