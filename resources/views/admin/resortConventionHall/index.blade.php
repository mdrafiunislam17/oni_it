...
@section("title", "Our ongoing projects  ")
...
@section("content")
    ...
    <main>
            ...
            <div class="container-xl px-4">
                <div class="page-header-content pt-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <h1 class="text-white"> All Our ongoing projects</h1>

                        <a href="{{ route('dashboard.resort-convention-halls.create') }}"
                           class="btn btn-light text-primary">
                            + Add Our ongoing projects
                        </a>
                    </div>
                </div>
            </div>
        ...
        <div class="container-xl px-4 mt-n10">
            ...
            <div class="card mb-4">
                <div class="card-header">All Our ongoing projects</div>
...
{{--                                    <th> Beds</th>--}}
{{--                                    <th> Size</th>--}}
{{--                                    <th> Our ongoing projects Type</th>--}}
                                    <th>Status</th>
                                ...
                                <tbody id="tableBody">
                                @forelse($resortConventionHall as $key => $item)
                                    <tr>
                                        <td>{{ $key + 1 }}</td>

                                        <td>
                                            @if($item->image)
                                                <img src="{{ asset('uploads/resortConventionHall/' . $item->image) }}"
                                                     width="50" height="35"
...
{{--                                        <td>{{ $item->size }}</td>--}}
{{--                                        <td>--}}
{{--                                            @if($item->propertyType == 'convention_hall')--}}
{{--                                                <div>হোটেল</div>--}}

{{--                                            @elseif($item->propertyType == 'resort')--}}
{{--                                                <div>রিসোর্ট</div>--}}
...
{{--                                        </td>--}}
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('dashboard.resort-convention-halls.edit', $item->id) }}"
...
{{--                                                  action="{{ route('dashboard.resort-convention-halls.destroy', $item->id) }}"--}}
{{--                                                  method="POST"--}}
{{--                                                  style="display:none;">--}}
{{--                                                @csrf--}}
{{--                                                @method('DELETE')--}}
{{--                                            </form>--}}
                                ...
                                @empty
                                    <tr>
                                        <td colspan="6" class="text-center">No Our ongoing projects  Found</td>
                                    </tr>
                                @endforelse
                                </tbody>
                            </table>
    ...
    <div id="deleteModal" class="custom-modal">
        <div class="custom-modal-content">
            <div class="icon">❗</div>
            <h3>Delete Our ongoing projects</h3>
            <p>Are you sure you want to delete this Our ongoing projects?<br>This action cannot be undone.</p>
