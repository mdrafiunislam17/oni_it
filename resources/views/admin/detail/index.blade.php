            ...
            <div class="container-xl px-4">
                <div class="page-header-content pt-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <h1 class="text-white">Detail List</h1>

                        <a href="{{ route('dashboard.detail.create') }}" class="btn btn-light text-primary">
                            + Add Detail
                        </a>
                    </div>
                </div>
                            ...
                            <table id="countryTable" class="datatable-table table align-middle">
                                ...
                                @forelse($details as $key => $detail)
                                    <tr>
                                        ...
                                        <td>
                                            @if($detail->image)
                                                <img src="{{ asset('uploads/detail/' . $detail->image) }}"
                                                     width="50" height="35"
                                        ...
                                        <td>
                                            <a href="{{ route('dashboard.detail.edit', $detail->id) }}"
...
{{--                                                  action="{{ route('dashboard.detail.destroy', $detail->id) }}"--}}
{{--                                                  method="POST"--}}
{{--                                                  style="display:none;">--}}
{{--                                                @csrf--}}
{{--                                                @method('DELETE')--}}
