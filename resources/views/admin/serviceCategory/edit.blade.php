    ...
    <main>
        ...
        <header class="page-header bg-gradient-primary-to-secondary pb-5">
            <div class="container-xl px-4 pt-4">
                <h1 class="text-white">Edit Service Category</h1>
            </div>
        </header>
        ...
        <div class="container-xl px-4 mt-n4">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form id="productForm"
                          action="{{ route('dashboard.serviceCategory.update', $serviceCategory->id) }}"
                          method="POST"
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-12">
                                <label class="form-label">Service Category Title *</label>
                                <input type="text"
                                       class="form-control"
                                       name="title"
                            ...
                            {{-- Main Image --}}
                            <div class="col-md-12">
                                <label class="form-label">Service Category Image</label>
                                ...
                                <div class="upload-box">
                                    ...
                                    <div class="image-preview-box mt-3"
                                         id="imagePreviewBox"
                                         style="{{ $serviceCategory->image ? 'display:block;' : '' }}">

                                        <img id="imagePreview"
                                             alt="Service Category Image Preview"
                                             src="{{ $serviceCategory->image ? asset('uploads/serviceCategory/'.$serviceCategory->image) : '' }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea name="description"
                                          ...
                                          class="form-control"
                                          rows="6"
                                          placeholder="Write microcity description">{{ old('description', $serviceCategory->description) }}</textarea>
                            </div>
