...
@section("content")
    ...
    <main>
            ...
            <div class="container-xl px-4">
                <div class="page-header-content pt-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <h1 class="text-white">Screenshot List</h1>

                        <a href="{{ route('dashboard.skinshot.create') }}" class="btn btn-light text-primary">
                            + Add Screenshot
                        </a>
                    </div>
                </div>
        ...
        <div class="container-xl px-4 mt-n10">
            ...
            <div class="card mb-4">
                <div class="card-header">All Screenshot</div>
                            ...
                            <table id="countryTable" class="datatable-table table align-middle">
                                ...
                                @forelse($galleries as $key => $gallery)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('dashboard.skinshot.edit', $gallery->id) }}"
                                            ...
                                            <form id="delete-form-{{ $gallery->id }}"
                                                  action="{{ route('dashboard.skinshot.destroy', $gallery->id) }}"
                                                  method="POST"
                                                  style="display:none;">
                                                @csrf
                                                @method('DELETE')
