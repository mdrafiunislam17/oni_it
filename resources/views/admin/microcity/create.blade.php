...
@section("title", "Create Arabian Park")
                    ...
                    <div class="row align-items-center justify-content-between">
                        <div class="col-auto mt-4">
                            ...
                            <div class="page-header-subtitle mt-2">
                                Add a new Arabian Park with image and description
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container-xl px-4 mt-n10">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <form id="productForm"
                          action="{{ route('dashboard.microcity.store') }}"
                          method="POST"
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text"
                                       ...
                                       name="title"
                                       value="{{ old('title') }}"
                                       placeholder="Enter Arabian Park title"
                                       required>
                            </div>
