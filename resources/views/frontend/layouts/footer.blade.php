...
{{--                <img src="{{ asset('frontend/images/logo-white.webp') }}" class="logo-footer" alt="" >--}}
                ...
                <div class="social-icons mb-sm-30">
                    <a href="{{ $settings["SETTING_SOCIAL_FACEBOOK"] }}"><i class="fa-brands fa-facebook-f"></i></a>
                    <a href="{{ $settings["SETTING_SOCIAL_TWITTER"] }}"><i class="fa-brands fa-x-twitter"></i></a>
                    <a href="{{ $settings["SETTING_SOCIAL_INSTAGRAM"] }}"><i class="fa-brands fa-instagram"></i></a>
                    <a href="{{ $settings["SETTING_SOCIAL_YOUTUBE"] }}"><i class="fa-brands fa-youtube"></i></a>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-sm-6">
                        <div class="widget">
                            ...
                            <ul>
                                <li><a href="{{ route('frontend.microcity') }}">মাইক্রোসিটি </a></li>
                                <li><a href="{{route('frontend.resort-convention-halls')}} ">রিসোর্ট ও কনভেনশন হল</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="de-flex">
                        <div class="de-flex-col">
                            কপিরাইট &copy; {{ now()->year }}  <a href="#">প্রাসাদ</a> সর্বস্বত্ব সংরক্ষিত ডেভেলপ বাই  <a href="https://stardesignbd.com/" target="_blank">স্টার ডিজাইন বিডি</a>
                        </div>
{{--                        <ul class="list-inline">--}}
{{--                            <li class="list-inline-item"><a href="#">শর্তাবলী এবং </a></li>--}}
{{--                            <li class="list-inline-item"><a href="#">গোপনীয়তা নীতি</a></li>--}}
{{--                        </ul>--}}
                    </div>
                </div>
            </div>
