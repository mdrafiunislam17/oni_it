...
@section("title", "Edit Special Goal")
    ...
    <main>
        ...
        <header class="page-header bg-gradient-primary-to-secondary pb-5">
            <div class="container-xl px-4 pt-4">
                <h1 class="text-white">Edit Special Goal</h1>
            </div>
        </header>
        ...
        <div class="container-xl px-4 mt-n4">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form id="productForm"
                          action="{{ route('dashboard.specialGoal.update', $specialGoal->id) }}"
                          method="POST"
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-12">
                                <label class="form-label">Special Goal Title *</label>
                                <input type="text"
                                       class="form-control"
                                       name="title"
                                       value="{{ old('title', $specialGoal->title) }}"
                                       placeholder="Enter specialGoal title">
                            </div>

                            <div class="col-md-12">
                                <label class="form-label">Special Goal Serial *</label>
                                <input type="text"
                                       class="form-control"
                                       name="serial"
                                       value="{{ old('serial', $specialGoal->serial) }}"
                                       placeholder="Enter specialGoal serial">
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea name="description"
                                          ...
                                          class="form-control"
                                          rows="6"
                                          placeholder="Write specialGoal description">{{ old('description', $specialGoal->description) }}</textarea>
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <select name="status" class="form-control">
                                    <option value="1" {{ $specialGoal->status == 1 ? 'selected' : '' }}>
                                        Active
                                    </option>
                                    <option value="0" {{ $specialGoal->status == 0 ? 'selected' : '' }}>
                                        Inactive
                                    </option>
                                </select>
                            </div>
                        ...
                        <div class="action-btns">
                            ...
                            <a href="{{ route('dashboard.specialGoal.index') }}"
