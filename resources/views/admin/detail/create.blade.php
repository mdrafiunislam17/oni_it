            ...
            <div class="page-header-content pt-4">
                <div class="row align-items-center justify-content-between">
                    <div class="col-auto mt-4">
                        <h1 class="page-header-title">Detail Create</h1>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <form id="countryForm" action="{{ route('dashboard.detail.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="hero-item">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <textarea class="form-control hero-name" name="title" rows="3" placeholder="Enter Detail title"></textarea>
                                        </div>
...
<script>
    ...
    function addMore() {
        ...
        let html = `
            <div class="hero-item">
                <button type="button" class="btn btn-danger btn-sm remove-btn" onclick="removeDetail(this)">Remove</button>
        ...
        document.getElementById('heroWrapper').insertAdjacentHTML('beforeend', html);

        initTinyMCE();
    }

    function removeDetail(button) {
        let item = button.closest('.hero-item');
