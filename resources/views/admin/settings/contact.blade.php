    ...
    <main>
        ...
        <div class="container-xl px-4 mt-n10">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card mb-4">
                        <div class="card-header">Manage Contact Information</div>
                        <div class="card-body">
...
{{--                                        <div class="section-title">Header Contact Information</div>--}}
{{--                                    </div>--}}

{{--                                    <div class="col-md-4 mb-3">--}}
{{--                                        <label for="HEADER_CONTACT_EMAIL" class="form-label">Messenger</label>--}}
{{--                                        <input--}}
{{--                                            class="form-control"--}}
{{--                                            id="HEADER_CONTACT_EMAIL"--}}
{{--                                            name="HEADER_CONTACT_EMAIL"--}}
{{--                                            type="text"--}}
{{--                                            value="{{ old('HEADER_CONTACT_EMAIL', $settings['HEADER_CONTACT_EMAIL'] ?? '') }}"--}}
{{--                                            placeholder="Enter header contact email">--}}
{{--                                    </div>--}}

{{--                                    <div class="col-md-4 mb-3">--}}
{{--                                        <label for="HEADER_CONTACT_PHONE" class="form-label">Footer Contact Phone</label>--}}
{{--                                        <input--}}
{{--                                            class="form-control"--}}
{{--                                            id="HEADER_CONTACT_PHONE"--}}
{{--                                            name="HEADER_CONTACT_PHONE"--}}
{{--                                            type="text"--}}
{{--                                            value="{{ old('HEADER_CONTACT_PHONE', $settings['HEADER_CONTACT_PHONE'] ?? '') }}"--}}
{{--                                            placeholder="Enter header contact phone">--}}
{{--                                    </div>--}}

{{--                                    <div class="col-md-4 mb-3">--}}
{{--                                        <label for="HEADER_CONTACT_WhatsApp" class="form-label"> WhatsApp Number</label>--}}
{{--                                        <input--}}
{{--                                            class="form-control"--}}
{{--                                            id="HEADER_CONTACT_WhatsApp"--}}
{{--                                            name="HEADER_CONTACT_WhatsApp"--}}
{{--                                            type="text"--}}
{{--                                            value="{{ old('HEADER_CONTACT_WhatsApp', $settings['HEADER_CONTACT_WhatsApp'] ?? '') }}"--}}
{{--                                            placeholder="Enter header contact phone">--}}
{{--                                    </div>--}}

                                    <div class="col-md-12 mb-4 mt-2">
                                        <div class="section-title">Page Contact Information</div>
                                    </div>
...
{{--                                            name="CONTACT_EMAIL"--}}
{{--                                            type="email"--}}
{{--                                            value="{{ old('CONTACT_EMAIL', $settings[''] ?? '') }}"--}}
{{--                                            placeholder="Enter contact email">--}}
                                        ...
                                        <textarea
                                            ...
                                            spellcheck="false"
                                            autocomplete="off"
                                        >{{ old('CONTACT_EMAIL', $settings['CONTACT_EMAIL'] ?? '') }}</textarea>
                                    </div>
...
{{--                                            placeholder="Enter contact phone">--}}
                                        <textarea
                                            ...
                                            spellcheck="false"
                                            autocomplete="off"
                                        >{{ old('CONTACT_PHONE', $settings['CONTACT_PHONE'] ?? '') }}</textarea>
                                    </div>
...
{{--                                    <div class="col-md-12 mb-3">--}}
{{--                                        <label for="CONTACT_GOOGLE_MAP" class="form-label">Google Map Embed Code</label>--}}
{{--                                        <textarea--}}
...
{{--                                        >{{ old('CONTACT_GOOGLE_MAP', $settings['CONTACT_GOOGLE_MAP'] ?? '') }}</textarea>--}}
{{--                                    </div>--}}
                                </div>
