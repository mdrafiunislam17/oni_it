...
@section("content")
    ...
    <main>
            ...
            <div class="container-xl px-4">
                <div class="page-header-content pt-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <h1 class="text-white"> All Special Goal</h1>

                        <a href="{{ route('dashboard.specialGoal.create') }}"
        ...
        <div class="container-xl px-4 mt-n10">
            ...
            <div class="card mb-4">
                <div class="card-header">All Special Goal</div>
                    ...
                    <div class="datatable-wrapper datatable-loading no-footer sortable searchable fixed-columns">
                        ...
                        <div class="datatable-container">
                            <table id="countryTable" class="datatable-table table align-middle">
                                ...
                                <tbody id="tableBody">
                                @forelse($specialGoal as $key => $item)
                                    <tr>
                                        <td>{{ $key + 1 }}</td>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('dashboard.specialGoal.edit', $item->id) }}"
                                            ...
                                            <form id="delete-form-{{ $item->id }}"
                                                  action="{{ route('dashboard.specialGoal.destroy', $item->id) }}"
                                                  method="POST"
                                                  style="display:none;">
                                                @csrf
                                                @method('DELETE')
                                ...
                                @empty
                                    <tr>
                                        <td colspan="6" class="text-center">No Special Goal  Found</td>
                                    </tr>
                                @endforelse
                                </tbody>
                            </table>
    ...
    <div id="deleteModal" class="custom-modal">
        <div class="custom-modal-content">
            <div class="icon">❗</div>
            <h3>Delete Special Goal</h3>
            <p>Are you sure you want to delete this Special Goal?<br>This action cannot be undone.</p>
