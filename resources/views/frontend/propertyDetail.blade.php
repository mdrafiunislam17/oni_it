        ...
        <div class="container">
            <div class="page-title_content">
                ...
                <div class="bread-crumb wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1200ms">
                    ...
                    <span class="current">প্রজেক্ট বিবরণ</span>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col-lg-10 col-md-12 col-sm-12">
                    <div class="property-detail">
                        <div class="property-detail_image">
                            <img src="{{ asset('uploads/property/'.$property->image_thumb) }}" alt="{{ $property->title }}" />
                        </div>
                        ...
                        <ul class="property-detail_meta d-flex flex-wrap mb-3">
                            ...
                            <li><i class="fa-regular fa-calendar"></i> {{ \Carbon\Carbon::parse($property->created_at)->translatedFormat('d M, Y') }}</li>
                        </ul>

                        <h3 class="property-detail_heading">{{ $property->title }}</h3>
                            ...
                            <div class="single-item_slider swiper-container">
                                <div class="swiper-wrapper">
                                    @if($property->floor_plans_image)
                                        @foreach(json_decode($property->floor_plans_image) as $image)
                                            <div class="swiper-slide">
                                                <div class="image">
                                                    <img src="{{ asset('uploads/property/' . $image) }}" alt="Floor Plan" style="width: 500px;">
                                                </div>
                                            </div>
                                        @endforeach
                                    @endif
