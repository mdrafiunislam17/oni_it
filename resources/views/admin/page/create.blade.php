                            ...
                            <div class="card-body">
                                ...
                                <div class="sbp-preview">
                                    <div class="sbp-preview-content">
                                        <form id="countryForm" action="{{ route('dashboard.page.store') }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <textarea name="description"
                                                              id="description"
                                                              class="form-control modern-input">{{ old('description') }}</textarea>
                                            ...
                                            <div class="mb-0">
                                                ...
                                                <a href="{{ route('dashboard.page.index') }}" class="btn btn-secondary">Back</a>
                                            </div>
                                            </div>
                                        </form>
                                    </div>
