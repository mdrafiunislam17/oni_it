...
@section("title", "Spectacular Edit")
        ...
        <div class="container-xl px-4 mt-n10">
            <div class="row">
                <div class="col-lg-12">
                    <div id="default">
                        <div class="card mb-4">
                            <div class="card-header">Edit Spectacular </div>
                            <div class="card-body">
                                ...
                                <div class="sbp-preview">
                                    <div class="sbp-preview-content">
                                        <form id="countryForm" action="{{ route('dashboard.gallery.update', $gallery->id) }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            @method('PUT')
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    <label for="title" class="form-label">Spectacular Title <span class="text-danger">*</span></label>
                                                    <input class="form-control" id="title" name="title" type="text" value="{{ old('title', $gallery->title) }}" >
                                                </div>
                                            ...
                                            <div class="mb-0">
                                                ...
                                                <a href="{{ route('dashboard.gallery.index') }}" class="btn btn-secondary">Back</a>
                                            </div>
                                            </div>
                                        </form>
                                    </div>
...
@push("scripts")
    ...
    <script>
        ...
        document.getElementById('flag').addEventListener('change', function () {
            imagePreview(this, 'flagPreview', 'flagPreviewBox');
        });
