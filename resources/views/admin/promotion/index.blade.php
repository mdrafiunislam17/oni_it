            ...
            <div class="container-xl px-4">
                <div class="page-header-content pt-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <h1 class="text-white"> All Promotions</h1>
...
{{--                        </a>--}}
        ...
        <div class="container-xl px-4 mt-n10">
            ...
            <div class="card mb-4">
                <div class="card-header">All Promotions</div>
                            ...
                            <table id="countryTable" class="datatable-table table align-middle">
                                ...
                                @forelse($promotions as $key => $item)
                                    <tr>
                                        ...
                                        <td>
                                            @if($item->image)
                                                <img src="{{ asset('uploads/promotions/' . $item->image) }}"
                                                     width="50" height="35"
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('dashboard.promotions.edit', $item->id) }}"
...
{{--                                                  action="{{ route('dashboard.promotions.destroy', $item->id) }}"--}}
{{--                                                  method="POST"--}}
{{--                                                  style="display:none;">--}}
{{--                                                @csrf--}}
{{--                                                @method('DELETE')--}}
{{--                                            </form>--}}
    ...
    <div id="deleteModal" class="custom-modal">
        <div class="custom-modal-content">
            ...
            <p>Are you sure you want to delete this promotions?<br>This action cannot be undone.</p>
