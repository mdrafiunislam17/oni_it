                    ...
                    <div class="row align-items-center justify-content-between">
                        <div class="col-auto mt-4">
                            ...
                            <div class="page-header-subtitle mt-2">
                                Update your homepage hero section information
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div id="default">
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <form id="heroForm" action="{{ route('dashboard.hero.update', $hero->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                        ...
                                        <select class="form-control" id="page_id" name="page_id">
                                            ...
                                            @foreach($pages as $page)
                                                <option value="{{ $page->id }}"
                                                    {{ old('page_id', $hero->page_id ?? '') == $page->id ? 'selected' : '' }}>
                                                    {{ $page->title }}
                                                </option>
                                            @endforeach
                                        </select>
...
{{--                                                 style="{{ !empty($hero->image) ? 'display:flex;' : 'display:none;' }}">--}}
{{--                                                <img--}}
{{--                                                    id="imagePreview"--}}
{{--                                                    src="{{ !empty($hero->image) ? asset($hero->image) : '' }}"--}}
{{--                                                    alt="Preview"--}}
{{--                                                >--}}
{{--                                            </div>--}}
{{--                                        </div>--}}
{{--                                    </div>--}}
        ...
        <div id="submitLoader" class="submit-loader">
            <div class="loader-card">
                ...
                <p class="text-muted mb-0">Your hero section is being updated.</p>
            </div>
        </div>
        </div>
    </main>
