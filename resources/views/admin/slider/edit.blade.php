                ...
                <div class="col-lg-12">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <form id="sliderForm"
                                  action="{{ route('dashboard.slider.update', $slider->id) }}"
                                  method="POST"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="upload-box">
                                            ...
                                            <div class="image-preview-box"
                                                 id="imagePreviewBox"
                                                 style="{{ $slider->image ? 'display:flex;' : '' }}">

                                                <img id="imagePreview"
                                                     src="{{ $slider->image ? asset('uploads/slider/' . $slider->image) : '' }}"
                                                     data-old-src="{{ $slider->image ? asset('uploads/slider/' . $slider->image) : '' }}"
                                                     alt="Image Preview">
                                            </div>
                                        </div>
                                    </div>
