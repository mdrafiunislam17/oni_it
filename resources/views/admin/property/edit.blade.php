        ...
        <div class="container-xl px-4 mt-n4">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form id="productForm"
                          action="{{ route('dashboard.property.update', $property->id) }}"
                          method="POST"
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="upload-box">
                                    ...
                                    <div class="image-preview-box mt-3"
                                         id="imagePreviewBox"
                                         style="{{ $property->image ? 'display:block;' : '' }}">

                                        <img id="imagePreview"
                                             alt="Project Image Preview"
                                             src="{{ $property->image ? asset('uploads/property/'.$property->image) : '' }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="upload-box">
                                    ...
                                    <div class="d-flex flex-wrap gap-2 mt-3" id="existingFloorImages">
                                        @php
                                            $floorPlanImages = json_decode($property->floor_plans_image ?? '[]', true);
                                        @endphp
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea name="description"
                                          ...
                                          class="form-control"
                                          rows="6"
                                          placeholder="Write project description">{{ old('description', $property->description) }}</textarea>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="propertyType" class="form-control">
                                    <option value="ongoing" {{ $property->propertyType == 'ongoing' ? 'selected' : '' }}>
                                        চলমান
                                    </option>
                                    <option value="outgoing" {{ $property->propertyType == 'outgoing' ? 'selected' : '' }}>
                                        বহির্গামী
                                    </option>
                                </select>
                            </div>
...
@push("scripts")
    ...
    <script>
        ...
        // Remove existing floor plan image from form
